...
// Pure & offline: no network. (An {info:true} option once attached models.dev metadata;
// no call site ever passed it, so `info` was permanently null. Deleted 2026-08-10.)
//
 ...
 * @param {{tenantId?:string, store:import('./store.js').CredentialStore, baseUrl?:string, protocol?:'openai'|'anthropic'}} opts
 * @returns {Promise<ResolvedModel>}
 */
export async function resolveModel(ref, { tenantId, store, baseUrl, protocol } = {}) {
